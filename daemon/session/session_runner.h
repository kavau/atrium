...
of the specified type (greeter or user). The ipc_channel is used for
daemon-greeter communication and can be NULL for a user session. This function
is itself executed as a child process of the daemon - the session runner. It
exits when the session has completed. */
